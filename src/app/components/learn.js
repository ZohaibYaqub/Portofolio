      ...
      <section className="text-gray-600 body-font cursor-pointer font-Poppins  ">
        <div className="container px-5 py-1 mx-auto   ">
          ...
          <div className="flex flex-wrap -m-4 ">
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden shadow-md dark:bg-slate-800">
                <Image className="lg:h-48 md:h-36 sm:h-1/2 w-full object-cover object-center  " src="https://plus.unsplash.com/premium_photo-1676637656166-cb7b3a43b81a?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="blog" width={384} height={216} />
                <div className="p-6">
                  <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">FREE COURSE</h2>
